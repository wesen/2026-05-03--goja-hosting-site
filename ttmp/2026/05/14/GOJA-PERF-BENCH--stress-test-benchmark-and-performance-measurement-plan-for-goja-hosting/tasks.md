...
- [x] Run short matrix end-to-end through SQLite and render report.
- [x] Upload SQLite-backed smoke report bundle to reMarkable.
- [x] Upload SQLite-backed short report bundle to reMarkable.
